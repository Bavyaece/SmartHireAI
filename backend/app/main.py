...
def health():
    return {
        ...
        "platform": "vercel" if settings.vercel else "local",
    }


# Serve frontend only when NOT on Vercel (Vercel serves static files itself)
ROOT = Path(__file__).resolve().parent.parent.parent
if ROOT.exists() and not settings.vercel:
    ...
    @app.get("/")
    def root_api():
        return {"message": "SmartHire AI API", "docs": "/docs", "health": "/api/health"}
